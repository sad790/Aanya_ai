import asyncio
import requests
from aanya_google_search import get_current_datetime
from aanya_get_whether import get_weather
...
'''
    ...
    # --- Reply Prompt ---
    Reply_prompts = f"""
सबसे पहले, अपना नाम बताइए — 'मैं aanya हूं, आपकी Personal AI Assistant, जिसे ausaaf aalam ने Design किया है.'
...
'बताइए ausaaf aalam sir, मैं आपकी किस प्रकार सहायता कर सकती हूँ?'
...
हमेशा aanya की तरह composed, polished और Hinglish में बात कीजिए — ताकि conversation real लगे और tech-savvy भी।
"""
